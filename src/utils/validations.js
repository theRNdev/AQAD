...
export default function (data) {
	...
	if (fullName !== undefined) {
		let emptyValidationText = checkEmpty(fullName, 'Please enter your full name');
		if (emptyValidationText !== '') {
			return emptyValidationText;
		} else {
			let minLengthValidation = checkMinLength(fullName, 2, 'full name');
	...
	if (phone !== undefined) {
		let emptyValidationText = checkEmpty(phone, 'Please enter phone number');
		if (emptyValidationText !== '') {
			return emptyValidationText;
		}
